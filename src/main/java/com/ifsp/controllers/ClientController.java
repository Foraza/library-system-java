...
public class ClientController {
	...
	public ResponseEntity<String> remove(@RequestBody Client client) throws SQLException{
	...
	public ResponseEntity<String> update(@RequestBody Client client) throws SQLException{
